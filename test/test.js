...
function createSuite(message, tests) {
...
createSuite('node-semver comparison tests', [
    ['0.0.0', '0.0.0-foo'],
    ['0.0.1', '0.0.0'],
    ['1.0.0', '0.9.9'],
    ['0.10.0', '0.9.0'],
...
createSuite('SemVish comparison tests', [
    ['2.0', '1.5', true],
    ['2.0', '1.9', true],
    ['2.0-rc1', '1.8', true],
    ['2.0', '2.0-rc1', true],
...
createSuite('Handle poorly formatted release date style versions', [
